...
- Expand MapOptions to set dark and light mode for specific map types. ([#17](https://github.com/Wild-Siena/google-maps-bundle/issues/17))

### Added

- Customization of advanced marker element. ([#15](https://github.com/Wild-Siena/google-maps-bundle/issues/15))

## [1.0.0] 2024-12-10

### Changed

- Expand MapOptions model with new properties to change the GestureType, that means you can control the zoom when scrolling.
  ([#5](https://github.com/Wild-Siena/google-maps-bundle/issues/5))
